...
class Vehicle(Base):
    ...
    fleetName = Column(String(120), nullable=True)
    corridor = Column(String(120), nullable=True)
    ...
    rfidTag = Column(String(120), nullable=True, index=True)
    mifareCard = Column(String(120), nullable=True, index=True)
    anprPlate = Column(String(120), nullable=True, index=True)
    bleIdentifier = Column(String(120), nullable=True, index=True)
